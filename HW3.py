...
app.layout=html.Div([
	...
	html.Div([
		html.Div([html.P("Graph 5", style={"font-weight":"bold", "padding-left":"25",}), html.P("Last graph is based on manually inputted data. It shows the Roadmap developed by an artificial startup. Task 1 is assumed to take the whole Janduary, while Task 2 is starting from March and ending in mid April. Afterwards, Task 3 begins and ends in the end of September. Recreate a similar Roadmap"),
			], className="four columns"),
