...
trace_gr5=[dict(Task="Task 1", Start="2018-01-01", Finish="2018-01-31"),
          dict(Task="Task2", Start="2018-03-01", Finish="2018-04-15"),
          dict(Task="Task3", Start="2018-04-15", Finish="2018-09-03")]

data_gr5=ff.create_gantt(trace_gr5)
layout_gr5=dict(title='Startup Roadmap')
gr5=dict(data=data_gr5, layout=layout_gr5)